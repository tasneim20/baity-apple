    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          "group-data-[side=right]:rotate-180 group-data-[side=end]:rotate-180",
      ...
      <div
        ...
        className={cn(
          ...
          variant === "floating" || variant === "inset"
            ...
            : "group-data-[collapsible=icon]:w-(--sidebar-width-icon) group-data-[side=left]:border-e group-data-[side=start]:border-e group-data-[side=right]:border-s group-data-[side=end]:border-s",
          className,
        )}
        {...props}
      >
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      className={cn(
        "hover:after:bg-sidebar-border absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-all ease-linear group-data-[side=left]:-end-4 group-data-[side=start]:-end-4 group-data-[side=right]:start-0 group-data-[side=end]:start-0 after:absolute after:inset-y-0 after:start-1/2 after:w-[2px] sm:flex",
